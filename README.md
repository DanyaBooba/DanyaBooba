...
- фреймворк Express платформы NodeJS и языка программирования JavaScript.

## В чем хочу развиваться

Хочу разрабатывать:

- мобильные приложения на фреймворке React Native языка программирования JavaScript;
- десктопные приложения с использованием фреймворка Qt или Electron.
